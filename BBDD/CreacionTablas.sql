...
CREATE TABLE EMPLEADO_PRODUCTO (
    ...
    CONSTRAINT ID_EMP_ID_PROD_EMPPROD_PK PRIMARY KEY (ID_EMPLEADO, ID_PRODUCTO),
...
CREATE TABLE EMPLEADO_PROVEEDOR (
    ID_EMPLEADO NUMBER(3),
    ID_PROVEEDOR NUMBER(3),
    CONSTRAINT ID_EMP_ID_PROV_EMPPROV_PK PRIMARY KEY (ID_EMPLEADO, ID_PROVEEDOR),
    CONSTRAINT ID_EMP_PROV_EMP_FK FOREIGN KEY (ID_EMPLEADO) REFERENCES EMPLEADO (ID_EMPLEADO),
    CONSTRAINT ID_PROV_EMP_EMP_FK FOREIGN KEY (ID_PROVEEDOR) REFERENCES PROVEEDOR (ID_PROVEEDOR)
